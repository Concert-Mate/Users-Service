package ru.nsu.concerts_mate.user_service.scheduler;

import lombok.RequiredArgsConstructor;
import org.springframework.context.annotation.Configuration;
import org.springframework.scheduling.annotation.EnableScheduling;
import org.springframework.scheduling.annotation.Scheduled;
import ru.nsu.concerts_mate.user_service.model.dto.ArtistDto;
import ru.nsu.concerts_mate.user_service.model.dto.ConcertDto;
import ru.nsu.concerts_mate.user_service.model.dto.UserDto;
import ru.nsu.concerts_mate.user_service.services.broker.BrokerEvent;
import ru.nsu.concerts_mate.user_service.services.broker.BrokerException;
import ru.nsu.concerts_mate.user_service.services.broker.BrokerService;
import ru.nsu.concerts_mate.user_service.services.music.MusicService;
import ru.nsu.concerts_mate.user_service.services.music.exceptions.MusicServiceException;
import ru.nsu.concerts_mate.user_service.services.users.UsersCitiesService;
import ru.nsu.concerts_mate.user_service.services.users.UsersService;
import ru.nsu.concerts_mate.user_service.services.users.UsersShownConcertsService;
import ru.nsu.concerts_mate.user_service.services.users.UsersTrackListsService;
import ru.nsu.concerts_mate.user_service.services.users.exceptions.InternalErrorException;
