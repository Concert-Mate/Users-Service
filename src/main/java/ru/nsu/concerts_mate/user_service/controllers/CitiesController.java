...
import ru.nsu.concerts_mate.user_service.api.cities.CitiesApi;
import ru.nsu.concerts_mate.user_service.api.cities.CitiesApiResponse;
import ru.nsu.concerts_mate.user_service.model.dto.CityDto;
import ru.nsu.concerts_mate.user_service.model.dto.CoordsDto;
import ru.nsu.concerts_mate.user_service.services.cities.CitiesService;
import ru.nsu.concerts_mate.user_service.services.cities.CitiesServiceException;
import ru.nsu.concerts_mate.user_service.services.cities.CitySearchByCoordsCode;
import ru.nsu.concerts_mate.user_service.services.cities.CitySearchByCoordsResult;
